...
public class BilldbHelper {
    ...
    public void CreateTable_users() {
    	try{
	        ...
	        db.execSQL("insert into tusers values (null,'Personal')");
	        db.execSQL("insert into tusers values (null,'Company')");
	    }catch(Exception e){
    ...
    public void InitAcctitem() {
    	try{
    	  //s.getBytes(encoding);
    	  db.execSQL("insert into acctitem values (1,null,'income')");
          db.execSQL("insert into acctitem values (2,1,'Salary')");
          db.execSQL("insert into acctitem values (9998,1,'Others')");
          db.execSQL("insert into acctitem values (0,null,'Outcome')");
          db.execSQL("insert into acctitem values (3,0,'daily use')");
          db.execSQL("insert into acctitem values (4,0,'Energy cost')");
          db.execSQL("insert into acctitem values (5,0,'Gas')");
          db.execSQL("insert into acctitem values (9999,0,'Others')");
          
          //db.execSQL("insert into bills values(100,135,10000,'','','Remark')");
    ...
    public String getBillsTotal(String date){
	    ...
	    while(!cur.isAfterLast()){
	    	...
	    	s="Monthly income:"+cur.getFloat(1)+" Outcome:"+cur.getFloat(0)+" Total:"+cur.getFloat(2);
	    	cur.moveToNext(); 
	    }
	    return s;
    }
