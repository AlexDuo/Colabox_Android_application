...
public class Grid_bills extends Activity implements OnItemLongClickListener {
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		// menu.add(0, 2, 0, " Delete ");//.setIcon(R.drawable.editbills);
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case 1:
			showDialog("Please choose the year and month:", "");
			return true;
		case 2:
	...
	public boolean onItemLongClick(AdapterView<?> parent, View view,
		...
		_id=(int)id;
		new AlertDialog.Builder(this).setTitle("Notice").setMessage(
				"Are you sure to delete the bill details?").setIcon(R.drawable.quit).setPositiveButton("Sure",
